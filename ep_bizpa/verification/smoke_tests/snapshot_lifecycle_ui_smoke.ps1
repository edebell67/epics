...
$frontendUrl = 'http://127.0.0.1:3003/?snapshotDemo=1&tab=quarter'
$screenshotPath = 'C:\Users\edebe\eds\workstream\verification\20260311_205200_bizpa_snapshot_lifecycle_ui.png'
$chromeProfilePath = 'C:\Users\edebe\eds\workstream\verification\chrome_capture_profile_snapshot_lifecycle'
