---
name: ep052-l2-implementation
description: Implement the EP052 l2 delivery scope when explicitly assigned, following its lean workflow and evidence gates; not a visiting-agent trading skill or agent runner.
---

<!-- VERSION HISTORY v1.0.0 · 2026-09-02 · Map-to-implementation guidance; runtime actions remain unimplemented. -->

# EP052 l2 implementation

Read the [workflow](../../workflows/EP052_l2_workflow.html) and [revised scope](../../lean_delivery/EP052_lean_scope_and_implementation_design.md). Node contracts are in [workflow-data.js](../../workflows/workflow-data.js).
...
Validate the map with `python scripts/validate_workflows.py --phase l2` from the epic root. That helper checks documentation linkage only; it does not execute or certify product gates. Planned application executors must be implemented before runtime acceptance.
